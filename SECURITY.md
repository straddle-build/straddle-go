...
This is a generated Go SDK for Straddle API, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Straddle API or service rather than in this SDK, report it through the security process Straddle API has published.
