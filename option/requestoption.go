...
// RequestOption is an option for the requests made by the Straddle API Client
...
// WithEnvironmentStraddleApiServer sets the default base URL to the "straddleapiserver" environment.
func WithEnvironmentStraddleApiServer() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://sandbox.straddle.com/")
}

// WithBearer returns a RequestOption that sets the client setting "Bearer".
func WithBearer(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
